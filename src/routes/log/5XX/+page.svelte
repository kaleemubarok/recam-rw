<script>
  ...
  */
  ...
  onMount(async () => {
    const response = await fetch(env.PUBLIC_API_ENDPOINT+"/logs/5XX",{
        method: "GET",
        headers: {
...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="header-primary mb-3">Dashboard - Riwayat Gagal</h1>
      <p class="subtitle-primary">
        Daftar komunikasi API yang belum berhasil <br class="desktop" />akibat kegagalan di sisi <i>endpoint</i> tujuan
      </p>
    </div>
  </div>
</div>
